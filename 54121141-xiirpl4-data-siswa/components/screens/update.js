    ...
    <View style={styles.container}>
      ...
      <View style={styles.main_content}>
        <View style={styles.form}>
          <Input title_input="NIS"/>
          <Input title_input="Nama"/>
          <Input title_input="Alamat"/>
          <Input title_input="Email"/>
          <Input title_input="Tanggal Lahir"/>
        </View>
        <View style={styles.button_pack}>
          <ButtonPrimaryyLarge onPress={() => navigation.navigate('Home')} tulisan="Perbarui Data"/>
        </View>
      </View>
